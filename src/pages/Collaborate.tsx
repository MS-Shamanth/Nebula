          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-card">
              ...
              <div className="space-y-3">
                {[
                  { name: "Dr. Maya Patel", status: "Editing intro", color: "bg-sentiment-curious" },
                  { name: "Sophie Martinez", status: "Reviewing section 3", color: "bg-sentiment-inspiring" },
                  { name: "Alex Chen", status: "Adding references", color: "bg-sentiment-joyful" },
                  { name: "You", status: "Viewing", color: "bg-primary" },
                ].map((user) => (
            ...
            <Card className="p-6 bg-card">
              ...
              <div className="space-y-3">
                {[
                  { section: "Introduction", status: "verified", count: 3 },
                  { section: "Methodology", status: "pending", count: 1 },
                  { section: "Case Studies", status: "verified", count: 5 },
                ].map((check) => (
                  <div key={check.section} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      {check.status === "verified" ? (
                        <CheckCircle className="w-4 h-4 text-sentiment-inspiring" />
                      ) : (
                        <AlertCircle className="w-4 h-4 text-sentiment-urgent" />
                      )}
            ...
            <Card className="p-6 bg-gradient-accent text-white">
              <div className="text-center space-y-3">
                ...
                <h3 className="font-bold">Verified Content</h3>
